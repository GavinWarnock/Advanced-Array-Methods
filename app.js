...
function problemTwo(){
    let results;
    let cuisineChosen = prompt("Which cuisine would you like?")
    results = dishes.filter(function(el){
        if(el.cuisine === cuisineChosen){
            return true
        }
        else{
            return false
...
console.log(chickpeaFood)
//7. Create a function that will prompt the user to type the name of one ingredient. Then use a filter to find all the dishes whose ingredients array INCLUDES that ingredient. Return the new array.
//Filter
function problemSeven(){
    let results;
    let chosenIngrediant = prompt("Choose an ingrediant.")
    results = dishes.filter(function(el){
        if(el.ingredients.includes(chosenIngrediant)){
            return true
        }
        else{
            return false
...
let ingrediantChosen = problemSeven()
console.log(ingrediantChosen)
